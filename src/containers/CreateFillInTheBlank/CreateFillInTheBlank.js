...
class CreateFillInTheBlank extends Component {
  constructor(props) {
    super(props);
  this.state = {
    title: {
  ...
  completed = (data) => {
    ...
    if (this.props.editmode) {
      ...
      this.setState({
        ...
        this.props.history.push(`/quiz/${data.createFillInTheBlank.uniqid}`);
      });
    }
  }
                  ...
                  onSubmit={e => {
                    ...
                    if (!this.props.user) {
                      ...
                      if (this.props.editmode) {
                        ...
                        createFillInTheBlank(variables);
                      }
                  }}>
    ...
    return (
      <div>
        <div className="CreateQuiz">
         <button className="BackButtonCreateQuiz" onClick={() => this.back()}>Back</button>
...
const ADD_LESSON = gql`
  mutation ($title: String!, $authorID: Int!, $sentences: [SentenceInput]) {
    createFillInTheBlank( title: $title, authorID: $authorID, sentences: $sentences) {
      created_at
      title
      authorID
      uniqid
...
const Container = withRouter(CreateFillInTheBlank);
