...
import { faHeading, faUnderline, faFont, faListUl, faListOl, faItalic, faBold, faQuoteLeft, faHighlighter, faTable, faCode } from '@fortawesome/free-solid-svg-icons';
...
export default class Slate extends Component {
      ...
      <div className="SlateEditor">
        {!this.props.readOnly &&
          <Toolbar>
            ...
            {this.renderBlockButton('heading-two', faFont)}
  ...
  renderMarkButton = (type, icon) => {
    ...
    return (
      ...
      >
        <FontAwesomeIcon className="SlateMarkIcon" icon={icon} size="lg" />
      </Button>
    )
  }
  ...
  renderMark = (props, editor, next) => {
    ...
    switch (mark.type) {
      case 'bold':
        return <span className="Bold" {...attributes}>{children}</span>
      case 'code':
